import{a9 as k,m as S,r as p,R as y,j as e,aa as E,ab as D,ac as z,ad as R,B as n,y as M,T as $}from"./index-DhbnydJl.js";import{h as P}from"./html2canvas.esm-BfYXEYrK.js";import{P as w}from"./printer-DeiqlOce.js";import{W as T}from"./wallet--cZcBirk.js";import{A as W}from"./arrow-left-DTf_k4UZ.js";import{S as _}from"./save-DZuHrrpv.js";import{D as L}from"./download-CAzB5lkL.js";const G=({isOpen:i,onClose:b,wallets:l,initialWalletId:d})=>{const{shopName:g}=k(),{toast:h}=S(),[s,c]=p.useState(null),[m,f]=p.useState("هذا الرقم خاص بالمحل، يرجى التأكد من الرقم قبل التحويل."),[v,u]=p.useState(!1),x=p.useRef(null);y.useEffect(()=>{if(i&&d){const t=l.find(a=>a.id===d);t&&c(t)}else i&&!d&&c(null)},[i,d,l]);const j=()=>{var r;if(!s)return;const t=`
...
//# sourceMappingURL=WalletPrinterDialog-B3yID8sa.js.map
