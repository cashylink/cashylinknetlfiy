import{j as e,a5 as S,a6 as z,a7 as D,a8 as T,ai as k,C as m,b as p,S as P,e as h,ao as A,U as x,G,B as c,_ as b}from"./index-bCWIXU_s.js";import{f as l}from"./formatters-Czs80nJy.js";import{B as y}from"./badge-D2_MGYyu.js";import{P as u}from"./phone-CgMYIHl6.js";import{D as j}from"./dollar-sign-Bao60D_X.js";import{C as E}from"./calendar-xPArWQ6D.js";import{P as L}from"./printer-BDVabvNO.js";import{T as R}from"./trash-2-BWgB-yFB.js";import{C as B}from"./circle-x-Cbud-81g.js";import{C as I}from"./circle-check-big-DiwZPFwf.js";const J=({isOpen:N,onClose:n,transaction:s,onDelete:w})=>{if(!s)return null;const v=t=>{switch(t){case"completed":return e.jsx(I,{className:"h-5 w-5 text-green-500"});case"pending":return e.jsx(b,{className:"h-5 w-5 text-yellow-500"});case"failed":return e.jsx(B,{className:"h-5 w-5 text-red-500"});default:return e.jsx(b,{className:"h-5 w-5 text-gray-500"})}},f=t=>{switch(t){case"completed":return"مكتملة";case"pending":return"قيد الانتظار";case"failed":return"فاشلة";default:return"غير معروف"}},g=t=>{switch(t){case"withdraw":return"سحب";case"send":return"إرسال";case"receive":return"استقبال";default:return"تحويل"}},$=()=>{const t=!!s.senderNumber,a=!!s.senderName,r=t?"الرقم المرسل:":a?"الرقم الراسل:":"رقم المحفظة:",i=t?s.senderNumber:a?s.senderName:s.senderPhone,o=`
