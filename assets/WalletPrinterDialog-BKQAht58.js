import{ab as k,m as S,r as p,R as y,j as e,ac as E,ad as D,ae as z,af as R,B as n,y as M,T as $}from"./index-CsOP4H3f.js";import{h as P}from"./html2canvas.esm-BfYXEYrK.js";import{P as w}from"./printer-Cfc3EArz.js";import{W as T}from"./wallet-DyayVLeF.js";import{A as W}from"./arrow-left-DxbKHWBf.js";import{S as _}from"./save-CXr5ha3W.js";import{D as L}from"./download-B7709DLU.js";const G=({isOpen:i,onClose:b,wallets:l,initialWalletId:d})=>{const{shopName:g}=k(),{toast:h}=S(),[s,c]=p.useState(null),[m,f]=p.useState("هذا الرقم خاص بالمحل، يرجى التأكد من الرقم قبل التحويل."),[v,u]=p.useState(!1),x=p.useRef(null);y.useEffect(()=>{if(i&&d){const t=l.find(a=>a.id===d);t&&c(t)}else i&&!d&&c(null)},[i,d,l]);const j=()=>{var r;if(!s)return;const t=`
