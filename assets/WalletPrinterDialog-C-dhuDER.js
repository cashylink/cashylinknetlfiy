import{ae as k,l as S,r as p,R as y,j as e,af as E,ag as D,ah as z,ai as R,B as n,x as M}from"./index-CzMrJEuC.js";import{T as $}from"./textarea-DH9YvORw.js";import{h as P}from"./html2canvas.esm-BfYXEYrK.js";import{P as w}from"./printer-BxRsauDr.js";import{W as T}from"./wallet-BpRPCgGm.js";import{A as W}from"./arrow-left-DE7YICBa.js";import{S as _}from"./save-C_zXO1pj.js";import{D as L}from"./download-CJ061BPe.js";const J=({isOpen:i,onClose:v,wallets:l,initialWalletId:d})=>{const{shopName:g}=k(),{toast:h}=S(),[s,c]=p.useState(null),[m,f]=p.useState("هذا الرقم خاص بالمحل، يرجى التأكد من الرقم قبل التحويل."),[b,u]=p.useState(!1),x=p.useRef(null);y.useEffect(()=>{if(i&&d){const t=l.find(a=>a.id===d);t&&c(t)}else i&&!d&&c(null)},[i,d,l]);const j=()=>{var r;if(!s)return;const t=`
...
//# sourceMappingURL=WalletPrinterDialog-C-dhuDER.js.map
