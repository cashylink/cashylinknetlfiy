import{a9 as k,m as S,r as p,R as y,j as e,aa as E,ab as D,ac as z,ad as R,B as n,y as M,T as $}from"./index-SMkF_y61.js";import{h as P}from"./html2canvas.esm-BfYXEYrK.js";import{P as w}from"./printer-cwHU0vwG.js";import{W as T}from"./wallet-DaYEE_f1.js";import{A as W}from"./arrow-left-BtArXwOa.js";import{S as _}from"./save-Deicy5o5.js";import{D as L}from"./download-khs-9dbB.js";const G=({isOpen:i,onClose:b,wallets:l,initialWalletId:d})=>{const{shopName:g}=k(),{toast:h}=S(),[s,c]=p.useState(null),[m,f]=p.useState("هذا الرقم خاص بالمحل، يرجى التأكد من الرقم قبل التحويل."),[v,u]=p.useState(!1),x=p.useRef(null);y.useEffect(()=>{if(i&&d){const t=l.find(a=>a.id===d);t&&c(t)}else i&&!d&&c(null)},[i,d,l]);const j=()=>{var r;if(!s)return;const t=`
...
//# sourceMappingURL=WalletPrinterDialog-DKOUkiAV.js.map
