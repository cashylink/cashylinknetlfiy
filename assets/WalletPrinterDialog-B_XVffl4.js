import{a4 as k,i as S,r as p,R as y,j as e,a5 as E,a6 as D,a7 as z,a8 as R,B as n,v as M}from"./index-CWTdLx7E.js";import{T as $}from"./textarea-Iv9lg92g.js";import{h as P}from"./html2canvas.esm-BfYXEYrK.js";import{P as w}from"./printer-B9qPCfB-.js";import{W as T}from"./wallet-CXLK-p8Q.js";import{A as W}from"./arrow-left-BnhAVXv5.js";import{S as _}from"./square-pen-DcDaycsB.js";import{D as L}from"./download-HXBKTopl.js";const J=({isOpen:i,onClose:v,wallets:l,initialWalletId:d})=>{const{shopName:g}=k(),{toast:h}=S(),[s,c]=p.useState(null),[m,f]=p.useState("هذا الرقم خاص بالمحل، يرجى التأكد من الرقم قبل التحويل."),[b,u]=p.useState(!1),x=p.useRef(null);y.useEffect(()=>{if(i&&d){const t=l.find(a=>a.id===d);t&&c(t)}else i&&!d&&c(null)},[i,d,l]);const j=()=>{var r;if(!s)return;const t=`
...
//# sourceMappingURL=WalletPrinterDialog-B_XVffl4.js.map
