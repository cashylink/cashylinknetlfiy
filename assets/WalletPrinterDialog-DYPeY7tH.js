import{ae as k,m as S,r as p,R as y,j as e,af as E,ag as D,ah as z,ai as R,B as n,y as M}from"./index-B_gBGKq7.js";import{T as $}from"./textarea-CEVbF0bg.js";import{h as P}from"./html2canvas.esm-BfYXEYrK.js";import{P as w}from"./printer-BhEFfqSw.js";import{W as T}from"./wallet-BSoaTeXa.js";import{A as W}from"./arrow-left-Bg8p_XH8.js";import{S as _}from"./save-BVFgWeAc.js";import{D as L}from"./download-B8PMjXuP.js";const J=({isOpen:i,onClose:v,wallets:l,initialWalletId:d})=>{const{shopName:g}=k(),{toast:h}=S(),[s,c]=p.useState(null),[m,f]=p.useState("هذا الرقم خاص بالمحل، يرجى التأكد من الرقم قبل التحويل."),[b,u]=p.useState(!1),x=p.useRef(null);y.useEffect(()=>{if(i&&d){const t=l.find(a=>a.id===d);t&&c(t)}else i&&!d&&c(null)},[i,d,l]);const j=()=>{var r;if(!s)return;const t=`
...
//# sourceMappingURL=WalletPrinterDialog-DYPeY7tH.js.map
