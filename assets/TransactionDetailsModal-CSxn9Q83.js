import{j as e,ae as S,af as z,ag as D,ah as k,ar as T,C as m,c as p,S as P,f as h,a1 as A,U as x,P as b,J as E,B as c,as as G,a7 as y}from"./index-mBSeGJ8K.js";import{f as l}from"./formatters-CO_Y-NDe.js";import{B as u}from"./badge-D4Cxv57Q.js";import{D as j}from"./dollar-sign-tQQ_yre_.js";import{C as L}from"./calendar-DWuCbuTk.js";import{P as R}from"./printer-C-vYmUsl.js";import{C as B}from"./circle-x-bWAeF-qD.js";import{C as I}from"./circle-check-big-C-Uwjs2Z.js";const X=({isOpen:N,onClose:n,transaction:s,onDelete:w})=>{if(!s)return null;const v=t=>{switch(t){case"completed":return e.jsx(I,{className:"h-5 w-5 text-green-500"});case"pending":return e.jsx(y,{className:"h-5 w-5 text-yellow-500"});case"failed":return e.jsx(B,{className:"h-5 w-5 text-red-500"});default:return e.jsx(y,{className:"h-5 w-5 text-gray-500"})}},f=t=>{switch(t){case"completed":return"مكتملة";case"pending":return"قيد الانتظار";case"failed":return"فاشلة";default:return"غير معروف"}},g=t=>{switch(t){case"withdraw":return"سحب";case"send":return"إرسال";case"receive":return"استقبال";default:return"تحويل"}},$=()=>{const t=!!s.senderNumber,a=!!s.senderName,r=t?"الرقم المرسل:":a?"الرقم الراسل:":"رقم المحفظة:",i=t?s.senderNumber:a?s.senderName:s.senderPhone,o=`
