import{j as e,ah as S,ai as k,aj as z,ak as D,av as T,c as m,d as p,aa as h,F as P,g as b,a4 as A,U as x,P as y,O as E,B as c,aw as G,C as u}from"./index-CgV0sHeM.js";import{f as l}from"./SimCardsAccessDialog-ja1xLiJY.js";import{D as j}from"./dollar-sign-CUtjmL1D.js";import{C as L}from"./calendar-0_98-YC1.js";import{P as R}from"./printer-D4O-3a9p.js";import{C as F}from"./users-DcT8Qdqe.js";import{C as I}from"./circle-check-big-iKMCgwGI.js";import"./select-Cjxh7T8L.js";const _=({isOpen:N,onClose:n,transaction:s,onDelete:w})=>{if(!s)return null;const v=t=>{switch(t){case"completed":return e.jsx(I,{className:"h-5 w-5 text-green-500"});case"pending":return e.jsx(u,{className:"h-5 w-5 text-yellow-500"});case"failed":return e.jsx(F,{className:"h-5 w-5 text-red-500"});default:return e.jsx(u,{className:"h-5 w-5 text-gray-500"})}},f=t=>{switch(t){case"completed":return"مكتملة";case"pending":return"قيد الانتظار";case"failed":return"فاشلة";default:return"غير معروف"}},g=t=>{switch(t){case"withdraw":return"سحب";case"send":return"إرسال";case"receive":return"استقبال";default:return"تحويل"}},$=()=>{const t=!!s.senderNumber,a=!!s.senderName,i=t?"الرقم المرسل:":a?"الرقم الراسل:":"رقم المحفظة:",r=t?s.senderNumber:a?s.senderName:s.senderPhone,o=`
