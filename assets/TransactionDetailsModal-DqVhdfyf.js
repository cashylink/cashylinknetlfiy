import{j as e,ac as S,ad as z,ae as D,af as k,ah as T,c as m,d as p,a2 as h,F as P,g as b,av as A,P as y,O as E,B as x,ai as L,C as u}from"./index-CsOP4H3f.js";import{f as l}from"./SimCardsAccessDialog-mC1wIUT3.js";import{U as c}from"./user-CASxJnpu.js";import{D as j}from"./dollar-sign-qt8uu6Yq.js";import{C as R}from"./calendar-BVHxzux7.js";import{P as F}from"./printer-Cfc3EArz.js";import{C as I}from"./circle-x-MNXan8yV.js";import{C as U}from"./circle-check-big-DooajqX_.js";import"./select-9pLpISkd.js";const q=({isOpen:N,onClose:i,transaction:s,onDelete:w})=>{if(!s)return null;const v=t=>{switch(t){case"completed":return e.jsx(U,{className:"h-5 w-5 text-green-500"});case"pending":return e.jsx(u,{className:"h-5 w-5 text-yellow-500"});case"failed":return e.jsx(I,{className:"h-5 w-5 text-red-500"});default:return e.jsx(u,{className:"h-5 w-5 text-gray-500"})}},f=t=>{switch(t){case"completed":return"مكتملة";case"pending":return"قيد الانتظار";case"failed":return"فاشلة";default:return"غير معروف"}},g=t=>{switch(t){case"withdraw":return"سحب";case"send":return"إرسال";case"receive":return"استقبال";default:return"تحويل"}},$=()=>{const t=!!s.senderNumber,a=!!s.senderName,r=t?"الرقم المرسل:":a?"الرقم الراسل:":"رقم المحفظة:",n=t?s.senderNumber:a?s.senderName:s.senderPhone,o=`
      <div style="font-family: 'Cairo', 'Segoe UI', Tahoma, sans-serif; max-width: 500px; margin: 0 auto; padding: 30px; background: #fff;">
        <!-- Header -->
        ...
        <div style="background: #fff; border: 2px solid #e2e8f0; border-radius: 12px; padding: 20px; margin-bottom: 20px;">
          ...
          ${s.type!=="withdraw"?`
            <div style="display: flex; justify-content: space-between; margin-bottom: 12px; padding: 8px 0; border-bottom: 1px solid #f1f5f9;">
              <span style="font-weight: 600; color: #475569;">${r}</span>
    ...
    `,d=window.open("","_blank");d&&(d.document.write(`
      ...
      `),d.document.close(),d.print())},C=()=>{window.confirm("هل أنت متأكد من حذف هذه المعاملة؟ لا يمكن التراجع عن هذا الإجراء.")&&(w(s.id),i())};return e.jsx(S,{open:N,onOpenChange:i,children:e.jsxs(z,{className:"w-[92vw] sm:w-auto sm:max-w-2xl max-h-[90vh] overflow-y-auto",children:[e.jsx(D,{children:e.jsxs(k,{className:"flex items-center gap-2 text-xl",children:[e.jsx(T,{className:"h-6 w-6 text-blue-600"}),"إيصال المعاملة المفصل"]})}),e.jsxs("div",{className:"space-y-6",children:[e.jsx(m,{className:"bg-gradient-to-r from-blue-50 to-indigo-50 border-blue-200",children:e.jsxs(p,{className:"text-center pb-2",children:[e.jsxs("div",{className:"flex items-center justify-center gap-2 mb-2",children:[v(s.status),e.jsx(h,{variant:s.status==="completed"?"default":"secondary",className:"text-sm",children:f(s.status)})]}),e.jsxs("h3",{className:"text-2xl font-bold text-blue-600",children:[s.type==="withdraw"?"-":"",l(s.amount)," جنيه"]}),e.jsxs("p",{className:"text-sm text-gray-600",children:["رقم المرجع: ",s.transactionReference||s.id]})]})}),e.jsxs(m,{children:[e.jsx(p,{className:"pb-3",children:e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsx(P,{className:"h-5 w-5 text-green-600"}),e.jsx("h4",{className:"font-semibold text-lg",children:"معلومات المحل"})]})}),e.jsxs(b,{className:"space-y-3",children:[e.jsxs("div",{className:"flex items-center justify-between p-3 bg-gray-50 rounded-lg",children:[e.jsx("span",{className:"font-medium text-gray-700",children:"اسم المحل:"}),e.jsx("span",{className:"text-gray-900",children:s.merchantShopName||s.shopName||"غير محدد"})]}),(s==null?void 0:s.cashierName)&&e.jsxs("div",{className:"flex items-center justify-between p-3 bg-gray-50 rounded-lg",children:[e.jsx("span",{className:"font-medium text-gray-700",children:"الكاشير:"}),e.jsx("span",{className:"text-gray-900",children:s.cashierName})]})]})]}),e.jsxs(m,{children:[e.jsx(p,{className:"pb-3",children:e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsx(A,{className:"h-5 w-5 text-blue-600"}),e.jsx("h4",{className:"font-semibold text-lg",children:"تفاصيل المعاملة"})]})}),e.jsx(b,{className:"space-y-3",children:e.jsxs("div",{className:"grid grid-cols-1 gap-3",children:[e.jsxs("div",{className:"flex items-center justify-between p-3 bg-blue-50 rounded-lg",children:[e.jsx("span",{className:"font-medium text-blue-700",children:"نوع المعاملة:"}),e.jsx(h,{variant:"outline",className:"bg-blue-100 text-blue-800",children:g(s.type)})]}),s.type!=="withdraw"?e.jsxs(e.Fragment,{children:[(()=>{const t=!!s.senderNumber,a=!!s.senderName,r=t?"الرقم المرسل:":a?"الرقم الراسل:":"رقم المحفظة:",n=t?s.senderNumber:a?s.senderName:s.senderPhone,o=t?c:y;return e.jsxs("div",{className:"flex items-center justify-between p-3 bg-gray-50 rounded-lg",children:[e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsx(o,{className:"h-4 w-4 text-gray-500"}),e.jsx("span",{className:"font-medium text-gray-700",children:r})]}),e.jsx("span",{className:"text-gray-900 font-mono",children:n})]})})(),e.jsx("div",{className:"flex items-center justify-center p-2",children:e.jsx(E,{className:"h-6 w-6 text-blue-500"})}),e.jsxs("div",{className:"flex items-center justify-between p-3 bg-green-50 rounded-lg",children:[e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsx(c,{className:"h-4 w-4 text-green-500"}),e.jsx("span",{className:"font-medium text-green-700",children:"الرقم المستقبل:"})]}),e.jsx("span",{className:"text-green-900 font-mono",children:s.receiverNumber||s.receiverPhone})]}),e.jsxs("div",{className:"flex items-center justify-between p-3 bg-blue-50 rounded-lg",children:[e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsx(j,{className:"h-4 w-4 text-blue-500"}),e.jsx("span",{className:"font-medium text-blue-700",children:"المبلغ المحول:"})]}),e.jsxs("span",{className:"text-blue-900 font-bold text-lg",children:[l(s.transferredAmount||s.amount)," جنيه"]})]})]}):e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:"flex items-center justify-between p-3 bg-gray-50 rounded-lg",children:[e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsx(y,{className:"h-4 w-4 text-gray-500"}),e.jsx("span",{className:"font-medium text-gray-700",children:"رقم المحفظة:"})]}),e.jsx("span",{className:"text-gray-900 font-mono",children:s.senderPhone})]}),(s==null?void 0:s.senderName)&&e.jsxs("div",{className:"flex items-center justify-between p-3 bg-gray-50 rounded-lg",children:[e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsx(c,{className:"h-4 w-4 text-gray-500"}),e.jsx("span",{className:"font-medium text-gray-700",children:"اسم صاحب المحفظة:"})]}),e.jsx("span",{className:"text-gray-900",children:s.senderName})]}),e.jsxs("div",{className:"flex items-center justify-between p-3 bg-red-50 rounded-lg",children:[e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsx(j,{className:"h-4 w-4 text-red-500"}),e.jsx("span",{className:"font-medium text-red-700",children:"المبلغ المسحوب:"})]}),e.jsxs("span",{className:"text-red-900 font-bold text-lg",children:[l(s.withdrawnAmountDetailed||s.withdrawnAmount||s.amount)," جنيه"]})]})]}),s.commission&&e.jsxs("div",{className:"flex items-center justify-between p-3 bg-yellow-50 rounded-lg",children:[e.jsx("span",{className:"font-medium text-yellow-700",children:"العمولة:"}),e.jsxs("span",{className:"text-yellow-900 font-semibold",children:[s.commission," جنيه"]})]}),s.commission&&e.jsxs("div",{className:"flex items-center justify-between p-3 bg-green-50 rounded-lg",children:[e.jsx("span",{className:"font-medium text-green-700",children:"الربح:"}),e.jsxs("span",{className:"text-green-900 font-semibold",children:[s.commission," جنيه"]})]}),(s==null?void 0:s.fee)&&Number(s.fee)>0&&e.jsxs("div",{className:"flex items-center justify-between p-3 bg-gray-50 rounded-lg",children:[e.jsx("span",{className:"font-medium text-gray-700",children:"الرسوم:"}),e.jsxs("span",{className:"text-gray-900 font-semibold",children:[s.fee," جنيه"]})]}),e.jsxs("div",{className:"flex items-center justify-between p-3 bg-gray-50 rounded-lg",children:[e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsx(R,{className:"h-4 w-4 text-gray-500"}),e.jsx("span",{className:"font-medium text-gray-700",children:"التاريخ والوقت:"})]}),e.jsx("span",{className:"text-gray-900",children:s.createdAt.toLocaleString("ar-EG")})]})]})})]}),e.jsxs("div",{className:"flex gap-3",children:[e.jsxs(x,{onClick:$,className:"flex-1 bg-blue-600 hover:bg-blue-700 text-white",size:"lg",children:[e.jsx(F,{className:"h-5 w-5 mr-2"}),"طباعة الإيصال"]}),e.jsxs(x,{onClick:C,variant:"destructive",className:"flex-1",size:"lg",children:[e.jsx(L,{className:"h-5 w-5 mr-2"}),"حذف المعاملة"]})]}),e.jsx(x,{onClick:i,variant:"outline",className:"w-full",size:"lg",children:"إغلاق الإيصال"})]})]})})};export{q as default};
//# sourceMappingURL=TransactionDetailsModal-DqVhdfyf.js.map
