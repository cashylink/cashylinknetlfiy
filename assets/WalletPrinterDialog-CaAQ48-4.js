import{ae as k,m as S,r as p,R as y,j as e,af as E,ag as D,ah as z,ai as R,B as n,y as M}from"./index-CHyvkdwe.js";import{T as $}from"./textarea-ymmQWf49.js";import{h as P}from"./html2canvas.esm-BfYXEYrK.js";import{P as w}from"./printer-tQRybv7D.js";import{W as T}from"./wallet-C8MuVqXX.js";import{A as W}from"./arrow-left-4i_BaYCY.js";import{S as _}from"./save-C1HQozbU.js";import{D as L}from"./download-CSyWgRqg.js";const J=({isOpen:i,onClose:v,wallets:l,initialWalletId:d})=>{const{shopName:g}=k(),{toast:h}=S(),[s,c]=p.useState(null),[m,f]=p.useState("هذا الرقم خاص بالمحل، يرجى التأكد من الرقم قبل التحويل."),[b,u]=p.useState(!1),x=p.useRef(null);y.useEffect(()=>{if(i&&d){const t=l.find(a=>a.id===d);t&&c(t)}else i&&!d&&c(null)},[i,d,l]);const j=()=>{var r;if(!s)return;const t=`
...
//# sourceMappingURL=WalletPrinterDialog-CaAQ48-4.js.map
