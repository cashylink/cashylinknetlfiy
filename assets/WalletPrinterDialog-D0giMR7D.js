import{ag as k,m as S,r as p,R as y,j as e,ah as E,ai as D,aj as z,ak as R,B as n,y as M,T as $}from"./index-CgV0sHeM.js";import{h as P}from"./html2canvas.esm-BfYXEYrK.js";import{P as w}from"./printer-D4O-3a9p.js";import{W as T}from"./wallet-BjpRmBYz.js";import{A as W}from"./arrow-left-L-ZCLYHX.js";import{S as _}from"./save-CK42wzuM.js";import{D as L}from"./download-DwDr96vs.js";const G=({isOpen:i,onClose:v,wallets:l,initialWalletId:d})=>{const{shopName:g}=k(),{toast:h}=S(),[s,c]=p.useState(null),[m,f]=p.useState("هذا الرقم خاص بالمحل، يرجى التأكد من الرقم قبل التحويل."),[b,u]=p.useState(!1),x=p.useRef(null);y.useEffect(()=>{if(i&&d){const t=l.find(a=>a.id===d);t&&c(t)}else i&&!d&&c(null)},[i,d,l]);const j=()=>{var r;if(!s)return;const t=`
...
//# sourceMappingURL=WalletPrinterDialog-D0giMR7D.js.map
